...
<body>
    ...
    <div class="main-content">
        <div class="top-header">
            <h4><i class="fas fa-plus-circle me-2"></i> Tambah Promo Baru</h4>
        </div>
            ...
            <div class="form-card">
                <form action="{{ route('admin.promo.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nama_promo" class="form-control" placeholder="contoh: Diskon Akhir Tahun" value="{{ old('nama_promo') }}" required>
                    </div>

                    <div class="mb-3">
                        <label class="form-label">Deskripsi <span class="text-danger">*</span></label>
                        <textarea name="deskripsi" class="form-control" rows="3" placeholder="Deskripsi promo..." required>{{ old('deskripsi') }}</textarea>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="diskon" class="form-control" placeholder="contoh: 20" min="1" max="100" value="{{ old('diskon') }}" required>
